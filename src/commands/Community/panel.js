...
اضغط على الأزرار بالأسفل للتعرف على السيرفر أكثر.
                `)
                // ارفع صورتك على Imgur أو Imgbb وضع رابطها المباشر هنا لكي لا تختفي
            ...
            console.error('حدث خطأ أثناء تشغيل الأمر:', error);
            await interaction.reply({ content: 'حدث خطأ داخلي أثناء إرسال اللوحة!', ephemeral: true });
        }
    },
};
